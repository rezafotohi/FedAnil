...
import time
from Models import CNN, Femnist_CNN
...
parser.add_argument('-mn', '--model_name', type=str, default='femnist_cnn', help='the model to train')
...
if __name__=="__main__":
	...
	if args['model_name'] == 'cnn':
		net = CNN()
	elif args['model_name'] == 'femnist_cnn':
		net = Femnist_CNN()
	...
	myClients = ClientsGroup('femnist', args['IID'], args['num_of_clients'], args['learning_rate'], dev, net, args['num_malicious'], args['noise_variance'], shard_test_data=args['shard_test_data'])
